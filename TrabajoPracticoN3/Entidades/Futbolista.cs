...
namespace Entidades
{
    public class Futbolista : Deportista, IArancel, ICuota
    {
        ...
        public Futbolista(string nombre, string apellido, DateTime fechaNac, long dni) 
            : base(nombre, apellido, fechaNac, dni, EDeportes.Futbol)
        {
            this.categoria = ECategoriasFutbol.Infantiles;
        }
        public Futbolista(string nombre, string apellido, DateTime fechaNac, long dni, ECategoriasFutbol categoria)
