...
namespace Entidades
{
    ...
    public abstract class Deportista : Socio
    {
        ...
        public Deportista(int numeroSocio, string nombre, string apellido, DateTime fechaNac, long dni) 
            :base(numeroSocio, nombre, apellido,fechaNac,dni)
        {
        }
        public Deportista(int numeroSocio, string nombre, string apellido, DateTime fechaNac, long dni, EDeportes deporte) 
