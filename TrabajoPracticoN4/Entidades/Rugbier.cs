...
namespace Entidades
{
    public class Rugbier : Deportista, IArancel, ICuota
    {
        ...
        public Rugbier(int numeroSocio, string nombre, string apellido, DateTime fechaNac, long dni) 
            : base(numeroSocio, nombre, apellido, fechaNac, dni, EDeportes.Rugby)
        {
            this.categoria = ECategoriasRugby.Sub14;
        }
        public Rugbier(int numeroSocio, string nombre, string apellido, DateTime fechaNac, long dni, ECategoriasRugby categoria) 
